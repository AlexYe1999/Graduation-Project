...
UploadBuffer::UploadBuffer(const ComPtr<ID3D12Device8>& device, size_t byteSize)
...
void UploadBuffer::CopyData(const uint8_t* data, size_t byteSize, size_t offset) const{
	void* mappedData;
